    ...
    public static void main(String[] args) throws Exception {
            ...
            if(recheio==1){ 
               ...
               System.out.printf("\n\u001B[32m" + "Recheio escolhido: MORANGO" + "\u001B[0m\n");
                ...
                System.out.printf("\n\u001B[32m" + "Recheio escolhido: MOUSSE DE LIMÃO TRADICIONAL COM PEDAÇOS DE CHOCOLATE AO LEITE/AMARGO" + "\u001B[0m\n");
             }else if(recheio==11){ 
                System.out.printf("\n\u001B[32m" + "Recheio escolhido: MOUSSE DE CHOCOLATE TRADICIONAL" + "\u001B[0m\n");
             }else if(recheio==12){ 
                System.out.printf("\n\u001B[32m" + "Recheio escolhido: MOUSSE DE CHOCOLATE COM PEDAÇOS DE CHOCOLATE AO LEITE/AMARGO" + "\u001B[0m\n");
             }else if(recheio==13){ 
                ...
                System.out.printf("\n\u001B[32m" + "Recheio escolhido: NINHO COM PEDAÇO DE CHOCOLATE AO LEITE OU AMARGO" + "\u001B[0m\n");
             }else if(recheio==17){ 
                ...
                System.out.printf("\n\u001B[32m" + "Recheio escolhido: BRIGADEIRO GOURMET COM CHOCOLATE AO LEITE OU AMARGO" + "\u001B[0m\n");
             }else if(recheio==21){ 
            ...
            if(confirm==1 && recheio ==1){
                 ...
                 System.out.printf("Seu pedido é:\n");
                 System.out.format("\n\u001B[33m" + "Recheio de: MOUSSE DE LIMÃO TRADICIONAL COM PEDAÇOS DE CHOCOLATE AO LEITE/AMARGO" + "\u001B[0m\n");
                 System.out.format("\n\u001B[33m" + "Sabor da massa: %s" + "\u001B[0m\n",confirm1);
                 System.out.format("\n\u001B[33m" + "Quantidade de: %.2fKG" + "\u001B[0m\n",quantidadeKg);
                 System.out.format("\n\u001B[33m" + "Terá topper com o tema: %s" + "\u001B[0m\n",temaTopper);
                 System.out.format("\n\u001B[33m" + "E o valor total do pedido será:\nR$%.2f" + "\u001B[0m\n",totalT);
                 ...
                 System.out.printf("Seu pedido é:\n");
                 System.out.format("\n\u001B[33m" + "Recheio de: MOUSSE DE CHOCOLATE COM PEDAÇOS DE CHOCOLATE AO LEITE/AMARGO" + "\u001B[0m\n");
                 System.out.format("\n\u001B[33m" + "Sabor da massa: %s" + "\u001B[0m\n",confirm1);
                 System.out.format("\n\u001B[33m" + "Quantidade de: %.2fKG" + "\u001B[0m\n",quantidadeKg);
                 System.out.format("\n\u001B[33m" + "Terá topper com o tema: %s" + "\u001B[0m\n",temaTopper);
                 System.out.format("\n\u001B[33m" + "E o valor total do pedido será:\nR$%.2f" + "\u001B[0m\n",totalT);
